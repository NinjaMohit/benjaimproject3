...
export class Framework_equipment_basic {
  ...
  @ManyToOne(() => Framework_equipment_basic, (eqtype) => eqtype.children, {
    nullable: true,
  })
  @JoinColumn({ name: 'parent_id' }) // Explicitly map the foreign key
  parent: Framework_equipment_basic;

  @OneToMany(() => Framework_equipment_basic, (eqtype) => eqtype.parent)
  children: Framework_equipment_basic[];
